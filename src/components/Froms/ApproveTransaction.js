        ...
        <Box mt={3} >
          ...
          >
              ...
              <TextField fullWidth id="propertyId" name="propertyId" label="Property ID" variant="outlined" />
                 ...
                 <Grid item lg={4} md={4} sm={4} > 
              <TextField fullWidth id="sellerCnic" type="number" name="sellerCnic" label="Seller CNIC" variant="outlined" />
                
                 </Grid>

                 <Grid item lg={4} md={4} sm={4} > 
              <TextField fullWidth id="buyerCNIC" type="number" name="buyerCNIC" label="Buyer CNIC" variant="outlined" />
                
                 </Grid>

                 <Grid item lg={4} md={4} sm={4} > 
              <TextField fullWidth id="requestNum" type="number" name="requestNum" label="Request Number" variant="outlined" />
